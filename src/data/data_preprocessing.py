# fetch data from data/interim (train and test) > preprocessing (lower,remove url, stop words and punctuation, Lemmatization) > store data inside data/processed

from nltk.stem import WordNetLemmatizer
from nltk.corpus import stopwords
import logging, nltk, os, re
import pandas as pd

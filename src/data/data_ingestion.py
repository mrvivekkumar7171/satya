# fetch data from url or data/raw > Basic Data Cleaning (drop missing values, remove duplicate and empty strings etc.) > Train-Test-split > Store the two set inside data/interim
...
def main():
    try:
        ...
        # df = load_data(data_url='./data/raw/reddit.csv') # Uncomment to use data from local raw folder (not using as data folder is not pushed to the git repo)
        ...
        # Save the split datasets and create the interim folder if it doesn't exist
